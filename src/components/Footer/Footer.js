...
const Footer = () => {
  return (
    <footer className="text-center text-lg-start bg-bg text-muted">
          ...
          <div className="row mt-3">
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">
                <i className="fas fa-gem me-"></i>Programming Republic
              </h6>
              <p>
              We are the best programming company in the world!!!
              </p>
            </div>
      ...
      <div className="text-center p-4" >
        © 2021 Copyright:
        <a className="text-reset fw-bold" href="http://localhost:3000/home">ProgrammingRepublic.com </a>
      </div>
    </footer>
  );
};
